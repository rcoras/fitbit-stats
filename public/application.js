...
var onStartGame = function onStartGame(event) {
  ...
  $('.answer-box').show();
  var randomIndex = Math.floor(Math.random() * (49 - 0)) + 0;
  var stateToGuess = states[randomIndex];
...
var onSumbitAnswer = function onSumbitAnswer(event) {
